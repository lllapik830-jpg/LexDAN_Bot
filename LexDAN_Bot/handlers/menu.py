...
async def open_chat(m: Message):
    ...
    await m.reply(
        "Погнали общаться 🙂\n\n"
        "Пиши или кидай голосовое на английском.\n"
        "Если ошибешься — мягко поправлю и объясню почему.\n"
        "Если всё ок — просто похвалю и продолжим диалог ✨\n\n"
        "🌍 Перевести — переведу мой последний ответ\n"
        "🔙 В меню — выход",
