...
DF_DONE_HTML = (
    ...
    "Остальные искры сможешь посмотреть <b>после прохождения обучения</b>.\n\n"
    "Осталось пройти <b>один урок</b> — и ты полностью поймёшь концепцию бота 💚\n\n"
    "Предлагаю первую тему по грамматике:\n\n"
