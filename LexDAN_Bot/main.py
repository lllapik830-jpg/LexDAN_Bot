...
from handlers import start, common, voice, chat, lessons, lessons_grammar, lessons_vocabulary, lessons_listening, lessons_sections, profile, menu, payments, secret_missions, admin
