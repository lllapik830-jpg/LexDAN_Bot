...
def section_intro_html(level: str | None) -> str:
    ...
    by_lv = {
        "A1": (
            "🤙 <b>Живая речь · A1</b>\n\n"
            "🦜 Учебник говорит по слогам. Люди — нет.\n\n"
            "🌀 <b>«Глотание слов»</b> · wanna, don'tcha, c'mon\n"
            "😎 <b>По-свойски</b> · yeah, nope, see ya\n"
            "🎧 <b>Диалоги</b> · пять сценок, потом вопросы голосом\n\n"
            "💎 <b>Эксклюзив безлимитного тарифа</b> — живая речь как у носителей!"
        ),
        "A2": (
            "🤙 <b>Живая речь · A2</b>\n\n"
            "🚀 Планы, переписка, времена как говорят — и <b>пять диалогов</b> 🎧\n\n"
            "💎 <b>Эксклюзив безлимитного тарифа</b>"
        ),
        "B1": (
            "🤙 <b>Живая речь · B1</b>\n\n"
        ...
        "C1": (
            "🤙 <b>Живая речь · C1</b>\n\n"
            "✨ Склейки, сленг и диалоги как у носителей "
            "(материал B2, регистр живой).\n\n"
            "💎 <b>Эксклюзив безлимитного тарифа</b>"
        ),
        "C2": (
            "🤙 <b>Живая речь · C2</b>\n\n"
            "👑 Звучать не как эссе, а как человек: сленг, регистр, "
            "диалоги носителей.\n\n"
            "💎 <b>Эксклюзив безлимитного тарифа</b>"
        ),
    }
