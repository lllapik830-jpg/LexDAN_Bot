    ...
    "A0": [
        ...
        },
        {
            ...
            "rico_intro": (
                ...
                "• <b>Hello!</b> — более формально (учитель, незнакомые люди)\n"
                "• <b>Hi!</b> — с друзьями, неформально\n"
                "<i>• Привет!</i>\n"
...
def format_topics_list(
    ...
    lines.append(
        "\n✨ После прохождения <b>всех тем</b> откроется "
        "<b>🎯 Тест по уровню</b>.\n"
        "Сдал тест → откроется <b>следующий уровень</b> 🚀\n\n"
        "📝 <b>Доп. задания</b> помогают закрепить материал — "
        "рекомендуем после теста по уровню "
        "(доступны на безлимите)."
    )
    return "\n".join(lines)
