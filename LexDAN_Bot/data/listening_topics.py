...
LISTENING_TOPICS: dict[str, list[dict]] = {
    ...
    "C1": [
        {"id": "negotiation", "title_ru": "Переговоры", "title_en": "Negotiation", "roles": "Alexey and Sergey", "setting": "partnership, financing, staged payments"},
        {"id": "conference", "title_ru": "Конференция", "title_en": "Conference", "roles": "Anna and Dmitry", "setting": "40 minutes, Q and A, projector microphone"},
        {"id": "healthcare", "title_ru": "Страховка", "title_en": "Insurance", "roles": "Irina and Elena", "setting": "flat all-risks, premium, 15000 roubles"},
        {"id": "debate_soft", "title_ru": "Дискуссия", "title_en": "Debate", "roles": "Dmitry and Ekaterina", "setting": "online learning, hybrid, quality"},
        {"id": "hr", "title_ru": "HR-разговор", "title_en": "HR talk", "roles": "Anton and Maxim", "setting": "CV, professionals, growth, contact later"},
        {"id": "mediator", "title_ru": "Медиация", "title_en": "Mediation", "roles": "Olga, Ivan and Mikhail", "setting": "evening noise, quiet after 22:00"},
        {"id": "research", "title_ru": "Исследование", "title_en": "Research chat", "roles": "Natalia and Alexey", "setting": "stress productivity, two months, daily reports"},
        {"id": "politics_soft", "title_ru": "Городская политика", "title_en": "City policy", "roles": "Polina and Sergey", "setting": "green spaces, next year, public meeting"},
        {"id": "culture_c1", "title_ru": "Культура", "title_en": "Culture", "roles": "Elena and Konstantin", "setting": "exhibition, classical contemporary, dialogue"},
        {"id": "tech_support", "title_ru": "IT-поддержка", "title_en": "IT support", "roles": "engineer and user", "setting": "outage, workaround"},
    ],
    "C2": [
        {"id": "boardroom", "title_ru": "Совет директоров", "title_en": "Boardroom", "roles": "Olga and Andrey", "setting": "15% deficit, marketing, operating costs, next meeting"},
        {"id": "ethics", "title_ru": "Этика ИИ", "title_en": "AI ethics", "roles": "Anna and Denis", "setting": "courts, bias, tool not judge, human responsibility"},
        {"id": "diplomacy", "title_ru": "Дипломатия", "title_en": "Diplomacy", "roles": "Smirnov and Petrov", "setting": "non-interference, joint statement, balance of interests"},
        {"id": "critique", "title_ru": "Критика фильма", "title_en": "Film critique", "roles": "Maria and Andrey", "setting": "visual style, complex plot, second viewing"},
        {"id": "academia", "title_ru": "Академия", "title_en": "Academia", "roles": "Sergeev and Lebedeva", "setting": "data analysis, hypothesis, different angle"},
        {"id": "court", "title_ru": "Судебные прения", "title_en": "Courtroom", "roles": "Ivanov and Sokolova", "setting": "inadmissible evidence, justice over speed"},
        {"id": "climate", "title_ru": "Климат", "title_en": "Climate panel", "roles": "Orlova and Volkov", "setting": "crisis, city-level change, international cooperation"},
        {"id": "literature", "title_ru": "Литература", "title_en": "Literature salon", "roles": "Maximov and Ivanova", "setting": "commercialisation, stay true, revival"},
        {"id": "finance", "title_ru": "Финансы", "title_en": "Finance", "roles": "Borisov and Smirnova", "setting": "correction, tech renewables, startups, diversify"},
        {"id": "philosophy", "title_ru": "Философия", "title_en": "Philosophy", "roles": "Mikhail and Ekaterina", "setting": "free will illusion, social construct, dialogue"},
    ],
}
