...
LISTENING_TOPICS: dict[str, list[dict]] = {
    ...
    "A1": [
        ...
        {"id": "school", "title_ru": "Школа", "title_en": "School", "roles": "two students", "setting": "classes, homework, break"},
        {"id": "hobbies", "title_ru": "Хобби", "title_en": "Hobbies", "roles": "new friends", "setting": "sport, music, films"},
        {"id": "shopping_easy", "title_ru": "В магазине", "title_en": "Shopping", "roles": "cashier and shopper", "setting": "price, size, bag"},
        {"id": "daily", "title_ru": "Распорядок дня", "title_en": "Daily routine", "roles": "flatmates", "setting": "wake up, breakfast, work"},
        {"id": "bus", "title_ru": "На автобусе", "title_en": "On the bus", "roles": "passenger and driver", "setting": "ticket, next stop, where to get off"},
        {"id": "library", "title_ru": "В библиотеке", "title_en": "Library", "roles": "librarian and student", "setting": "borrow a book, return date"},
        {"id": "park", "title_ru": "В парке", "title_en": "In the park", "roles": "parent and child", "setting": "play, ice cream, go home"},
        {"id": "phone_easy", "title_ru": "Звонок другу", "title_en": "Phone call", "roles": "two friends", "setting": "are you free, meet at 5"},
        {"id": "clinic", "title_ru": "В поликлинике", "title_en": "Clinic", "roles": "nurse and patient", "setting": "appointment, wait, room number"},
    ],
    "A2": [
        {"id": "cafe", "title_ru": "Кафе с другом", "title_en": "Café with a friend", "roles": "two friends", "setting": "order drinks/food, evening plans"},
        {"id": "station", "title_ru": "На вокзале", "title_en": "Train station", "roles": "ticket clerk and traveller", "setting": "tickets, platform, delay"},
        {"id": "doctor", "title_ru": "У врача", "title_en": "Doctor", "roles": "doctor and patient", "setting": "symptoms, medicine, rest"},
        {"id": "hotel", "title_ru": "В отеле", "title_en": "Hotel", "roles": "receptionist and guest", "setting": "check-in, room, breakfast"},
        {"id": "police", "title_ru": "Полиция", "title_en": "Police", "roles": "police officer and citizen", "setting": "lost wallet, describe, report"},
        {"id": "bar", "title_ru": "В баре", "title_en": "Bar", "roles": "bartender and customer", "setting": "drink order, card or cash, last call"},
        {"id": "taxi", "title_ru": "Такси", "title_en": "Taxi", "roles": "driver and passenger", "setting": "address, traffic, price"},
        {"id": "post", "title_ru": "На почте", "title_en": "Post office", "roles": "clerk and customer", "setting": "send a parcel, stamp, tracking"},
        {"id": "gym_a2", "title_ru": "Спортзал", "title_en": "Gym", "roles": "trainer and client", "setting": "membership, schedule, tired"},
        {"id": "weather_plans", "title_ru": "Погода и планы", "title_en": "Weather plans", "roles": "two colleagues", "setting": "weekend plans depend on weather"},
    ],
    "B1": [
