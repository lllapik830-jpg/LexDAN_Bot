...
# C1/C2 — компактные детальные скрипты (C1 канон — data/listening_c1_fixed.py)
for _tid, _lines in {
    "negotiation": [
