...
GRAMMAR_SECTION_INTRO: dict[str, str] = {
    "A0": (
        "🌱 <b>Grammar · A0</b>\n\n"
        "Каждая тема — короткая история с примерами и переводом. "
        "Не зубри — понимай, и будет легко ✨"
    ),
    "A1": (
        "🧱 <b>Grammar · A1</b>\n\n"
        "Строим фундамент: связный рассказ по теме, не сухие правила. "
        "С примерами и типичными ловушками 💪"
    ),
    "A2": (
        "🔥 <b>Grammar · A2</b>\n\n"
        "Времена, сравнения, типичные ошибки — всё по-человечески, "
        "с примерами и переводом."
    ),
    "B1": (
        "🎯 <b>Grammar · B1</b>\n\n"
        "Perfect, условные, пассив — разберём на живых примерах, "
        "чтобы говорить точнее."
    ),
    "B2": (
        "😎 <b>Grammar · B2</b>\n\n"
        "Серьёзные темы простым языком: нюансы, подводки и живые примеры."
    ),
    "C1": (
        "👑 <b>Grammar · C1</b>\n\n"
        "Полируем стиль: инверсия, cleft, номинализация — "
        "как рассказ, не как справочник."
    ),
    "C2": (
        "🏔️ <b>Grammar · C2</b>\n\n"
        "Тонкости носителя — интересно, понятно и с примерами ✨"
    ),
}
