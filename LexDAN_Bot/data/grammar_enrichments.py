...
TOPIC_ENRICHMENTS: dict[str, str] = {
    ...
    "plurals": (
        ...
        "• fish/fish (рыба), но fishes = виды рыб\n"
        "• potato→potatoes, но photo→photos\n\n"
        "💡 Неправильные множественные — учи списком 📋"
    ),
    "there_is_are": (
        "\n\n⚠️ <b>Подводки:</b>\n"
        "• There is + единственное; There are + множественное\n"
        "• There is a book and two pens — первое слово is\n"
        "• В вопросе: Is there…? / Are there…?\n\n"
        "💡 There is ≠ It is! There is a cat = «есть котик» 🐱"
    ),
    "can_ability": (
        "\n\n⚠️ <b>Подводки:</b>\n"
...
GRAMMAR_SECTION_INTRO: dict[str, str] = {
    "A0": (
        "🦜 <b>Рико:</b> Грамматика A0 — это не страшные правила, а первые кирпичики! 🧱\n"
        "Я объясню всё с переводом, примерами и ловушками — чтобы ты понимал, а не зубрил ✨"
    ),
    "A1": (
        "🦜 <b>Рико:</b> Грамматика A1 — строим фундамент! Каждая тема — с душой, "
        "примерами и подводками. Спрашивай что угодно 💪"
    ),
    "A2": (
        "🦜 <b>Рико:</b> A2 — уже интереснее! Разберём времена, сравнения и типичные ошибки. "
        "Я рядом на каждой теме 🔥"
    ),
    "B1": (
        "🦜 <b>Рико:</b> B1 — время говорить точнее! Perfect, условные, пассив — "
        "с примерами, переводом и исключениями 🎯"
    ),
    "B2": (
        "🦜 <b>Рико:</b> B2 — серьёзные темы, но объясню просто и с душой. "
        "Нюансы, подводки — всё здесь 😎"
    ),
    "C1": (
        "🦜 <b>Рико:</b> C1 — полируем стиль! Инверсия, cleft, номинализация — "
        "с примерами и ловушками 👑"
    ),
    "C2": (
        "🦜 <b>Рико:</b> C2 — вершина мастерства! Тонкости носителя, register, "
        "естественность — по максимуму 🏔️✨"
    ),
}
